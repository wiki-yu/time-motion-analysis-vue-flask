...
print("##### adabegi_path is: ", adabegi_path)

sys.path.append(adabegi_path)
models_path = os.path.join(actual_path, "trained_models")
print("##### trained_models path is: ", models_path)

sys.path.append(models_path)
data_path = os.path.join(actual_path, "data")
print("###### data path is: ", models_path)

# Load parsing information
